<script lang="ts">
	...
	import example_add_loader from './demo/example-add-loader.svelte?raw';
	import example_load_audio_click from './demo/example-load-audio-click.svelte?raw';
	import example_load_audio_mount from './demo/example-load-audio-mount.svelte?raw';
	import Hero from './layout/content/hero.svelte';
	import { Content, ContentTitle, Section, SectionTitle } from './layout/docs';
	import ContentListItem from './layout/docs/content-list-item.svelte';
	import Features from './layout/docs/features.svelte';
	import { topics } from './layout/registry';
